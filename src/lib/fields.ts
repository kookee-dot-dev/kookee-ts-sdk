 ...
 */
export function fieldOptionKey(fields: EntryFieldReadItem[] | null | undefined, slug: string): string | undefined {
  return fields?.find((field) => field.slug === slug)?.optionKeys[0];
}

/** Text-ish field value, or undefined when unset or of another type. */
export function fieldStringValue(fields: EntryFieldReadItem[] | null | undefined, slug: string): string | undefined {
...
export function findField(fields: EntryFieldValue[] | null | undefined, slug: string): EntryFieldValue | undefined {
